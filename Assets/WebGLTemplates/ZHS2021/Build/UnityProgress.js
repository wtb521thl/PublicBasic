...
function init()
{
  ...
  gameProgress = document.createElement("div");
  gameProgress.className = "progress ";
  container.appendChild(gameProgress);
  //canvas.appendChild(gameProgress);
  container.style.color = '#ff0000';
  gameProgress.appendChild(ele);
  gameProgress.appendChild(document.getElementById("loadcanvas"));

  var tip = document.createElement("div");
  tip.className = "tip";
  gameProgress.appendChild(tip); 
  ...
  container.style.backgroundImage="url(Build/background.png)";
}
